...
import { Scissors, ArrowLeft, Check, User, Clock, Calendar as CalendarIcon, Phone } from 'lucide-react';
...
const Booking = () => {
  ...
  const generateTimeSlots = () => {
    ...
    const slots: string[] = [];
    const [startHour, startMinute] = selectedBarber.work_start_time.split(':').map(Number);
    const [endHour, endMinute] = selectedBarber.work_end_time.split(':').map(Number);
    ...
    try {
      ...
      supabase.functions.invoke('send-confirmation-email', {
        body: {
          ...
          appointmentDate: format(selectedDate, "dd 'de' MMMM 'de' yyyy", { locale: ptBR }),
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-display text-xl font-bold text-foreground">Agendar</span>
            </div>
            <div className="w-20" />
          </div>
        </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {barbers.map((barber) => (
                ...
                >
                  ...
                  <div>
                    <p className="font-display font-semibold text-foreground">{barber.name}</p>

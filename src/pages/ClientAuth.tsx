      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-card border-r border-border flex-col justify-between p-12">
        ...
        <div>
          ...
          <h2 className="font-display text-3xl font-bold text-foreground mb-4">
            Agende seu corte
            <span className="block text-gradient-gold">de forma simples</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            Escolha seu barbeiro favorito, selecione o serviço e agende o melhor horário para você.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <p className="text-muted-foreground mb-8">
            {isLogin ? 'Acesse sua conta para agendar' : 'Cadastre-se para começar a agendar'}
          </p>
